...
class PrettyPrinter extends LogPrinter {
  ...
  ///
  /// For example:
  /// * #1      Logger.log (package:logger_test/src/logger_test.dart:115:29)
  static final _deviceStackTraceRegex = RegExp(r'#[0-9]+\s+(.+) \((\S+)\)');

  /// Matches a stacktrace line as generated by Flutter web.
  ///
  /// For example:
  /// * packages/logger_test/src/printers/pretty_printer.dart 91:37
  ...
  /// For example:
  /// * dart:sdk_internal
  /// * package:logger_test/src/logger_test.dart
  ...
  ///
  /// For example, to exclude your `MyLog` util that redirects to this logger_test:
  /// ```dart
  /// excludePaths: [
  ...
  bool _discardDeviceStacktraceLine(String line) {
    ...
    if (segment.startsWith('package:logger_test')) {
      return true;
    }
  ...
  bool _discardWebStacktraceLine(String line) {
    ...
    if (segment.startsWith('packages/logger_test') ||
